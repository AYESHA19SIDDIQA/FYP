...
try:
    ...
    def get_def_ds(mins):
        return None, ("D:/athar_code/edf", "NMT", "description", "results"), None
...
def main():
    ...
    try:
        ...
        curr_data = ("D:/athar_code/edf", "NMT", "description", "results")
    ...
    print("1. Use NeuroGATE_Gaze_MultiRes instead of NeuroGATE")
